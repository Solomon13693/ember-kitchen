...
create table orders (
  ...
  phone text not null,
  notes text,
  payment_method text check (payment_method in ('cod', 'paystack')),
...
-- Order status timeline (one timestamp per stage)
...
-- Addresses (optional — saved delivery addresses)
...
-- orders: customers see their own, admin sees all
...
-- order_status_events: follow parent order visibility
...
-- =========================================================
-- Order status timeline triggers
-- =========================================================
...
-- =========================================================
-- Auto-create profile on signup (works with email confirmation)
-- =========================================================
